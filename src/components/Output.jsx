            ...
            <div className=" my-9 text-white flex flex-col justify-center items-center">
              <form onSubmit={handleSubmit}>
                ...
                <input
                  ...
                  className="border-2 border-slate-100/20 rounded-md py-1 px-2 focus:bg-gray-700 text-white bg-transparent my-2 md:mx-2"
                  onChange={(e) => setName(e.target.value)}
                  required
                />
                <button
                  type="submit"
                  className=" border-2 px-2 py-1 hover:bg-[#001d3d] text-sm sm:my-2"
                >
                  Submit Code
                </button>
              </form>
